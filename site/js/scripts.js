// chamo a função getParam e armazeno em id_grupo o valor do parâmetro 'id_grupo'
let id_grupo = getParam("id_grupo");

        // se tiver um id_grupo faça isso:
        if (id_grupo) {
            // get + url + id_grupo
            fetch("http://localhost:8080/produto/grupo/" + id_grupo)
